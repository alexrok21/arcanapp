...
if (!__VLS_ctx.isPremium) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        ...{ onClick: (__VLS_ctx.activatePremium) },
        ...{ class: "test-premium-button" },
    });
}
/** @type {__VLS_StyleScopedClasses['home-container']} */ ;
/** @type {__VLS_StyleScopedClasses['draws-counter']} */ ;
/** @type {__VLS_StyleScopedClasses['counter-icon']} */ ;
...
/** @type {__VLS_StyleScopedClasses['premium-label']} */ ;
...
/** @type {__VLS_StyleScopedClasses['test-premium-button']} */ ;
var __VLS_dollars;
