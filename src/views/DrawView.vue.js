...
if (__VLS_ctx.showLimitModal) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ onClick: (__VLS_ctx.closeLimitModal) },
        ...{ class: "limit-modal-overlay" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "limit-modal-content" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.h2, __VLS_intrinsicElements.h2)({
        ...{ class: "limit-title" },
    });
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        ...{ onClick: (__VLS_ctx.goToPremium) },
        ...{ class: "limit-button premium-button" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
        ...{ class: "button-bg-premium" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
        ...{ class: "button-text-premium" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        ...{ onClick: (__VLS_ctx.closeLimitModal) },
        ...{ class: "limit-button close-button" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
    if (!__VLS_ctx.isPremium) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            ...{ class: "premium-info" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({
            ...{ class: "premium-benefit" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({
            ...{ class: "premium-benefit" },
        });
...
/** @type {__VLS_StyleScopedClasses['app-name-wrapper']} */ ;
/** @type {__VLS_StyleScopedClasses['app-name-base']} */ ;
...
/** @type {__VLS_StyleScopedClasses['limit-modal-overlay']} */ ;
/** @type {__VLS_StyleScopedClasses['limit-modal-content']} */ ;
/** @type {__VLS_StyleScopedClasses['limit-title']} */ ;
/** @type {__VLS_StyleScopedClasses['limit-text']} */ ;
/** @type {__VLS_StyleScopedClasses['limit-icon']} */ ;
/** @type {__VLS_StyleScopedClasses['limit-actions']} */ ;
/** @type {__VLS_StyleScopedClasses['limit-button']} */ ;
/** @type {__VLS_StyleScopedClasses['premium-button']} */ ;
/** @type {__VLS_StyleScopedClasses['button-bg-premium']} */ ;
/** @type {__VLS_StyleScopedClasses['button-text-premium']} */ ;
/** @type {__VLS_StyleScopedClasses['limit-button']} */ ;
/** @type {__VLS_StyleScopedClasses['close-button']} */ ;
/** @type {__VLS_StyleScopedClasses['premium-info']} */ ;
/** @type {__VLS_StyleScopedClasses['premium-benefit']} */ ;
/** @type {__VLS_StyleScopedClasses['premium-benefit']} */ ;
/** @type {__VLS_StyleScopedClasses['premium-benefit']} */ ;
var __VLS_dollars;
