...
const cards = [
    {
       ...
       Es un recordatorio de que tú eres el artífice de tu destino.`,
            shortUpright: "Iniciativa y creatividad en acción. Tienes todas las herramientas para manifestar tus deseos.",
       ...
       Esta posición sugiere revisar tus intenciones, evitar juegos de poder y reconectar con tu propósito verdadero.`,
            shortReversed: "Cuidado con el poder mal utilizado. Revisa tus intenciones y reconecta con tu propósito auténtico.",
        },
    },
    {
        name: "La Sacerdotisa",
       ...
       Es un recordatorio de que no todo se revela a simple vista; hay capas de significado que solo se descubren con paciencia y observación.`,
            shortUpright: "Confía en tu intuición. La sabiduría interior revela lo que los ojos no ven.",
       ...
       Esta posición también sugiere que debes prestar atención a los sentimientos reprimidos o a situaciones ambiguas que están pidiendo claridad.`,
            shortReversed: "Tu intuición está silenciada. Enfrenta lo desconocido y reconcíliate con tu voz interior.",
        },
    },
    {
        name: "La Emperatriz",
       ...
       También simboliza la belleza, el arte y la maternidad en sus formas más amplias.`,
            shortUpright: "Abundancia creativa en floración. Nutre lo que siembras con amor y conexión con la naturaleza.",
       ...
       Esta posición invita a reconectar con tu cuerpo, establecer límites saludables y recordar que para dar, primero debes llenar tu propio vaso.`,
            shortReversed: "Te estás agotando. Establece límites y recuerda: para dar, primero debes nutrirte a ti mismo/a.",
        },
    },
    {
        name: "El Emperador",
       ...
       Invita a liderar con integridad, firmeza y visión, sin caer en la rigidez o el autoritarismo.`,
            shortUpright: "Liderazgo con estructura y visión. Establece límites claros y construye cimientos sólidos con integridad.",
       ...
       Es un llamado a ejercer el liderazgo con equilibrio, sin dominar ni someterte.`,
            shortReversed: "Rigidez o falta de control. Desarrolla tu autoridad interna y lidera con equilibrio, sin dominar ni someterte.",
        },
    },
    {
        name: "El Loco",
       ...
       Es un recordatorio de que a veces, perder el equilibrio es el primer paso hacia algo extraordinario.`,
            shortUpright: "Salto de fe hacia lo desconocido. Confía en tu intuición y abraza nuevas posibilidades con coraje.",
       ...
       Es un llamado a equilibrar la libertad con la responsabilidad, y a recordar que el verdadero viaje comienza cuando decides adónde ir, no solo en huir.`,
            shortReversed: "Estás huyendo o paralizado. Equilibra la libertad con responsabilidad y decide tu rumbo con claridad.",
        },
    },
    {
        name: "El Hierofante",
       ...
       También puede representar la necesidad de estructura moral o ética en tu vida, y el valor de pertenecer a una tradición que nutre el alma.`,
            shortUpright: "Tradición y guía espiritual. Busca sabiduría en maestros, rituales y comunidades que nutran tu alma.",
       ...
       Es un llamado a buscar sabiduría auténtica, más allá de las formas, y a honrar tu propia conexión con lo divino, incluso si no sigue las reglas establecidas.`,
            shortReversed: "Dogmatismo o aislamiento. Cuestiona creencias impuestas y busca tu propia conexión auténtica con lo sagrado.",
        },
    },
    {
        name: "Los Amantes",
       ...
       Es un recordatorio de que el verdadero amor nace cuando dos almas se encuentran en verdad y libertad.`,
            shortUpright: "Elección del corazón con autenticidad. Armoniza tus deseos y valores para crear uniones verdaderas.",
       ...
       Es un llamado a clarificar tus valores, sanar heridas emocionales y recordar que sin honestidad interior, ninguna unión puede ser verdadera.`,
            shortReversed: "Desalineación interna. Clarifica tus valores, sana heridas y elige con amor, no con miedo.",
        },
    },
    {
        name: "El Carro",
       ...
       El triunfo no viene de la fuerza bruta, sino del equilibrio interno y la claridad de propósito.`,
            shortUpright: "Avanza con determinación y equilibrio. Armoniza tus fuerzas internas para tomar el control de tu destino.",
       ...
       A veces, retroceder un paso es necesario para avanzar con verdadera fuerza.`,
            shortReversed: "Pierdes el control o el rumbo. Detente, reajusta tu dirección y reconecta con tu centro antes de avanzar.",
        },
    },
    {
        name: "La Fuerza",
       ...
       Es un recordatorio de que la verdadera fuerza no se impone: se irradia desde la calma.`,
            shortUpright: "Coraje del corazón con compasión. Domina tus impulsos con suavidad y transforma tus miedos en poder creativo.",
       ...
       La fuerza verdadera comienza cuando dejas de pelear contra ti mismo/a.`,
            shortReversed: "Debilidad o agresividad. Reprimes emociones o actúas con violencia. Reconcíliate contigo mismo/a y encuentra el equilibrio.",
        },
    },
    {
        name: "El Hermitaño",
       ...
       Es un llamado a la meditación, al descanso reflexivo y a confiar en que, aunque camines solo, no estás perdido: estás encontrándote.`,
            shortUpright: "Retirada consciente para escuchar tu sabiduría interior. Enciende tu lámpara y encuentra respuestas en la quietud.",
       ...
       A veces, la búsqueda termina cuando dejas de huir del mundo, y comienzas a caminar con tu lámpara encendida en medio de él.`,
            shortReversed: "Aislamiento sin propósito. Sal de tu retiro, comparte tu sabiduría y camina con tu lámpara encendida en el mundo.",
        },
    },
    {
       ...
       Abre tu corazón al misterio: estás en el centro del movimiento del universo.`,
            shortUpright: "Confía en el flujo del cambio. El universo alinea las circunstancias a tu favor. Todo es cíclico y temporal.",
       ...
       En lugar de resistir, observa, aprende y prepárate: tu momento volverá.`,
            shortReversed: "Resistes lo inevitable. Acepta el cambio, ajusta tus velas y prepárate: tu momento volverá en el ciclo.",
        },
    },
    {
        name: "La Justicia",
       ...
       Recuerda: la verdadera justicia no castiga, sino que restaura el orden con sabiduría.`,
            shortUpright: "Decide con equilibrio e integridad. Cada acción tiene consecuencias. Restaura el orden con sabiduría y verdad.",
       ...
       Es un llamado a actuar con honestidad, incluso cuando duela, y a recordar que no puedes escapar de tus decisiones: solo puedes aprender de ellas.`,
            shortReversed: "Sesgo o evasión de responsabilidad. Enfrenta la verdad incómoda y asume las consecuencias para cerrar el ciclo.",
        },
    },
    {
        name: "El Colgado",
       ...
       A veces, para avanzar, debes detenerte. Para ver claro, debes mirar al revés.`,
            shortUpright: "Pausa consciente para cambiar de perspectiva. Suelta el control y encuentra sabiduría en la quietud.",
       ...
       Acepta la suspensión: no es un castigo, es una invitación a ver más allá.`,
            shortReversed: "Resistes una pausa necesaria. Forzas resultados y te aferras al control. Acepta la suspensión: es gestación.",
        },
    },
    {
        name: "La Muerte",
       ...
       Recuerda: detrás de cada final, hay un amanecer oculto. La verdadera muerte es aferrarse a lo que ya murió.`,
            shortUpright: "Fin de un ciclo para renacer. Suelta con dignidad lo que ya no sirve y abre espacio para lo nuevo.",
       ...
       Deja que lo viejo se vaya: tu próxima versión ya está esperando.`,
            shortReversed: "Resistes un cambio necesario. Retienes lo que ya no funciona. Soltar es el primer paso hacia tu renacimiento.",
        },
    },
    {
        name: "La Templanza",
       ...
       Recuerda: la verdadera templanza no es contener el fuego, sino saber cuándo avivarlo y cuándo dejar que se calme.`,
            shortUpright: "Armoniza fuerzas opuestas con paciencia. Encuentra el flujo sereno entre cuerpo y alma para transformar lo ordinario.",
       ...
       Vuelve al centro: ahí está tu brújula.`,
            shortReversed: "Desequilibrio e impaciencia. Forzas resultados y pierdes tu centro. Vuelve al flujo sereno y escucha tu brújula interior.",
        },
    },
    {
        name: "La Torre",
       ...
       No es un castigo, sino una catástrofe sagrada que abre paso a una fundación más auténtica.`,
            shortUpright: "Colapso necesario que revela la verdad. Destruye ilusiones para construir sobre cimientos auténticos.",
       ...
       La caída duele, pero sobrevivirla te vuelve más fuerte que nunca.`,
            shortReversed: "Resistes el colapso inevitable. Suelta lo agrietado antes de que el universo lo derrumbe por ti.",
        },
    },
    {
        name: "La Estrella",
       ...
       No es una promesa de que todo será fácil, sino una certeza de que nunca estás solo/a en tu camino.`,
            shortUpright: "Esperanza que renace tras la tormenta. Confía en la guía del universo: incluso en la oscuridad, las estrellas brillan.",
       ...
       La esperanza no siempre viene del cielo: a veces, comienza cuando decides volver a creer.`,
            shortReversed: "Pérdida de fe y desesperanza. Reencuentra tu chispa interior: la esperanza nace cuando decides volver a creer.",
        },
    },
    {
        name: "La Luna",
       ...
       Lo que temes quizás no es el peligro, sino el descubrimiento de ti mismo/a.`,
            shortUpright: "Atraviesa la niebla de lo oculto. Confía en tu intuición: lo que emerge del misterio es tu verdad interior.",
       ...
       Acepta lo que se mueve en tu interior: no es para asustarte, es para sanarte.`,
            shortReversed: "Niegas tu sombra y rechazas la intuición. Enfrenta lo oculto: convertirte en la luz es tu único camino.",
        },
    },
    {
        name: "El Sol",
       ...
       No es solo felicidad: es realización. No es solo luz: es despertar.`,
            shortUpright: "Triunfo de la luz y la alegría auténtica. Tras las pruebas, llega la realización y el despertar con confianza.",
       ...
       Confía: tras cada eclipse, la luz regresa más fuerte.`,
            shortReversed: "Eclipse emocional o alegría forzada. Protege tu luz interior: tras cada sombra, el Sol renace más fuerte.",
        },
    },
    {
        name: "El Juicio",
       ...
       La vida te está dando una segunda oportunidad: levántate.`,
            shortUpright: "Despierta a tu llamado interior. Perdona el pasado y renace hacia tu propósito más elevado.",
       ...
       A veces, el mayor acto de valentía es simplemente decir: "Estoy listo/a".`,
            shortReversed: "Resistes tu despertar espiritual. Suelta la culpa y acepta la segunda oportunidad que mereces.",
        },
    },
    {
        name: "El Mundo",
       ...
       Puedes mirar atrás con orgullo, respirar hondo… y prepararte para lo que viene.`,
            shortUpright: "Culminación de un ciclo con plenitud. Celebra tu viaje completo y prepárate para lo que viene.",
       ...
       A veces, el último paso no es avanzar, sino detenerte, mirar atrás y decir: "Estoy listo/a para seguir".`,
            shortReversed: "Resistes cerrar un ciclo. Reconoce tu logro, suelta el pasado y avanza hacia lo nuevo.",
        },
    },
];
export const useTarotStore = defineStore("tarot", {
    state: () => ({
        ...
        lastDrawDate: null, // Fecha de última tirada
    ...
    actions: {
        ...
        setPremium(value) {
            ...
            if (value) {
                this.dailyDraws = 0; // Resetear contador al hacerse premium
            }
            this.saveToLocalStorage();
        },
